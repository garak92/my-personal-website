    ...
    <>
      <div className='dyn-height' style={{ position: 'relative' }}>
        ...
        <div className='paragraphDiv'>
          ...
          <p className='paragraph'>
            I code mostly in Javascript, Python, Rust, and SQL. As a hobby, I like dabbling into the world of
            systems programming, so I also use some C for my personal experiments.
          </p>
          <p className='paragraph'>
